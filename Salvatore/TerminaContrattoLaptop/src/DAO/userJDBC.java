...
public class userJDBC implements userDAO {
    ...
    public userSessionBean login(userSessionBean bean) throws SQLException, emptyResult {
        ...
        if (resultSet.next() == false){
            ...
            userSessionBean loggedUser = new userSessionBean(resultSet.getString("Nickname"), resultSet.getInt("ID"), resultSet.getString("tableName"), resultSet.getInt("paymentClaim"), "");
            resultSet.close();
            preparedStatement.close();
            return loggedUser;
        }
