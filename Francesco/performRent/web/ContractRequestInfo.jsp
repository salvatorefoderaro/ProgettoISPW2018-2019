...
<%@ page import="it.uniroma2.ispw.fersa.rentingManagement.entity.Rentable" %>
<%@ page import="it.uniroma2.ispw.fersa.rentingManagement.bean.RentableInfoBean" %>
<%@ page import="it.uniroma2.ispw.fersa.rentingManagement.bean.ContractRequestInfoBean" %>
<%@ page import="java.time.format.DateTimeFormatter" %>
<%@ page import="it.uniroma2.ispw.fersa.rentingManagement.entity.Service" %>
...
<%
    ...
    try {
        ...
        propertyBean = sessionBean.getControl().getPropertyInfo();
